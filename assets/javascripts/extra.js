...
.account-dialog .op-target{color:##maincolor##;word-wrap:break-word}
...
.ai-chat-btn-base-html-code{background-color:##maincolor##0d;border:1px solid ##maincolor##;border-radius:8px;color:##maincolor##;height:32px;padding:0 8px}
.ai-chat-input-btn-send-wrapper:not(.disabled){background-color:##maincolor##;cursor:pointer}
.ai-chat-input-btn-stop-wrapper{background-color:##maincolor##;border-radius:50%;cursor:pointer;height:32px;width:32px}
...
.ai-chat-message-user-text-segment{background-color:##maincolor##26;border-radius:6px 0 6px 6px;padding:10px}
...
.app-comment-footer .submit-comment .seatable-icon-send{color:##maincolor##}
...
.archive-dialog .op-target{color:##maincolor##;word-wrap:break-word}
...
.comment-editor-wrapper .comment-editor-toolbar .comment-editor-menu-group .comment-editor-menu-group-item[data-active=true]{color:##maincolor##}
...
.dtable-comment-footer .submit-comment .seatable-icon-send{color:##maincolor##}
...
.dtable-radio .dtable-radio-selected-indicator.dtable-radio-indicator-disable{background-color:##maincolor##}
.dtable-radio .dtable-radio-selected-indicator{background-color:##maincolor##;border:initial!important}
.dtable-rc-calendar .rc-calendar-right-panel-item-selected,.dtable-rc-calendar .rc-calendar-selected-date .rc-calendar-date,.rc-calendar-month-panel-selected-cell .rc-calendar-month-panel-month,.rc-calendar-month-panel-selected-cell .rc-calendar-month-panel-month:hover,.rc-calendar-year-panel-selected-cell .rc-calendar-year-panel-year,.rc-calendar-year-panel-selected-cell .rc-calendar-year-panel-year:hover{background:##maincolor##}
.dtable-rc-calendar .rc-calendar-today .rc-calendar-date{border:1px solid ##maincolor##}
...
.header-dropdown .dropdown-item:hover{background-color:##maincolor##;color:#fff;cursor:pointer}
.html-page-dev-config-tips .html-page-dev-config-help-text a{color:##maincolor##}
...
.mobile-row-comment-view .app-comment-footer .submit-comment-mobile .seatable-icon-send{color:##maincolor##}
...
.month-calendar .rc-calendar-month-panel-header>a,.year-calendar .rc-calendar-year-panel-header>a{color:##maincolor##;font-weight:700;height:18px!important;padding:4px 5px;text-align:center;width:30px;width:18px!important}
...
.rc-calendar-header>a:hover{color:##maincolor##;cursor:pointer}
.rc-calendar-ok-btn,.rc-calendar-time-picker-btn,.rc-calendar-today-btn{color:##maincolor##;display:inline-block;text-align:center}
...
.share-dialog .op-target{color:##maincolor##;word-wrap:break-word}
...
.widget-display-as .select-group-container .select-group-item.active{background-color:#fff2e4;box-shadow:0 0 0 1px ##maincolor##;color:##maincolor##}
