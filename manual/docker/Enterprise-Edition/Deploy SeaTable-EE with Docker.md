...
Download the [docker-compose.yml](https://docs.seatable.io/f/58f1f83e5ac34258806b/?dl=1) sample file into the SeaTable's directory and modify the file to fit your environment and settings.
