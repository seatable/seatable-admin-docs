...
- `group_by_stmt_limit`: Maximal number of concurrent group by requests. If the number of group by requests exceeds this limit, the query will block. Default is 2.
