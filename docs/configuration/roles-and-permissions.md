...
| big_data_storage_quota         | 4.3              | Total storage quota for all bases: '1G' means a limit of one gigabyte for big data storage; '' means no storage quota for big data storage                                                                              | This item is used for the role of teams rather than users. Does NOT apply to org users. |
