...
| **[Departments](departments.md)** | Hierarchical org structure | Enabled | Enterprises with formal org charts |
...
- **Departments** add a hierarchical structure on top of groups, where members of a sub-department are automatically members of all parent departments.
