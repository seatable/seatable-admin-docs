function update_css_color() {
  var color = document.getElementById("seatable_custom_color").value;
  console.log("Let me update the color in the css code to " + color);
  var divElement = document.getElementById("seatable_custom_color_output");
  var codeElement = divElement.querySelector("code");

  var v43 = `.account-dialog .nav .nav-item .nav-link.active{border-bottom:.125rem solid ##maincolor##;color:##maincolor##;text-decoration:none}
...
`;
  ...
  codeElement.textContent = v43.replaceAll("##maincolor##", color);
}
