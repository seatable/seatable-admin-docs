...
| Big data Import / export operations | Import from xlsx to big data storage | 500,000 records | Can be modified it in the configuration file |
|  | Update from xlsx to big data storage | 500,000 records | Can be modified it in the configuration file |
|  | Export big data view to Excel | 250,000 records | Can be modified it in the configuration file |
