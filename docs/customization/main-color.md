...
=== "Version 6.2"
    ...
    <input type="color" id="cc_v6.2" onchange="update_custom_color('v6.2')" value="#ff8000" style="width:100px">
    <div id="cc_output_v6.2">
    ```css
...
=== "Version 6.1"
    ...
    <input type="color" id="cc_v6.1" onchange="update_custom_color('v6.1')" value="#ff8000" style="width:100px">
    <div id="cc_output_v6.1">
    ```css
    Select a color and the css code will be created...
    ```
    </div>
...
=== "Version 6.0"
    ...
    <input type="color" id="cc_v6.0" onchange="update_custom_color('v6.0')" value="#ff8000" style="width:100px">
    <div id="cc_output_v6.0">
    ```css
    Select a color and the css code will be created...
    ```
    </div>
...
Login to your SeaTable Server as system administrator and switch to the system admin area. Select the navigation point `Settings`. Team admins or normal users do not have the permission to access the system admin area.
